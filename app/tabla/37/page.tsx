...
const schemaData = {
  ...
  "@graph": [
    ...
    {"@type": "LearningResource", "@id": "https://einmaleins.online/einmaleins/37#learningresource", "name": "37er-Einmaleins Lernressource", "description": "Multiplikation mit 37 - Fortgeschrittene Rechenmethoden", "educationalLevel": "Intermediate", "learningResourceType": ["Interactiund Resource", "Practice Material", "Educational Game"], "teaches": "37er-Einmaleins, Primzahl Konzept", "typicalAgeRange": "8-11", "inLanguage": "de", "educationalUse": ["practice", "self-study"], "audience": {"@type": "EducationalAudience", "educationalRole": ["student"]}, "isPartOf": {"@id": "https://einmaleins.online/31-40#learningresource"}}
  ]
}
