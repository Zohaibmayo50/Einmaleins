...
export const metadata: Metadata = {
  ...
  keywords: '96 Tabla de Multiplicar, 96 tablosu, Tabla de Multiplicar 96, matematik, çarpma işlemi',
  alternates: {
    canonical: '/tabla/96',
  },
}
