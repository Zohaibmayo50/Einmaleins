...
const schemaData = {
  ...
  "@graph": [
    ...
    {"@type": "LearningResource", "@id": "https://einmaleins.online/einmaleins/36#learningresource", "name": "36er-Einmaleins Lernressource", "description": "Multiplikation mit 36 - Fortgeschrittene Rechenmethoden", "educationalLevel": "Intermediate", "learningResourceType": ["Interactiund Resource", "Practice Material", "Educational Game"], "teaches": "36er-Einmaleins, 6� Konzept, 4�9 und 6�6 Beziehung", "typicalAgeRange": "8-11", "inLanguage": "de", "educationalUse": ["practice", "self-study"], "audience": {"@type": "EducationalAudience", "educationalRole": ["student"]}, "isPartOf": {"@id": "https://einmaleins.online/31-40#learningresource"}}
  ]
}
